...
./experiments/attack_and_test_transformer.sh 1 2 1 false 1 1 true 5 false false false v2-3-z_rand_1-pgd_5_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME} $TRANSFORM_NAME 0.05 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# # z-1 sites opt, pgd 3
