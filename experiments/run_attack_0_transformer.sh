...
# MODEL_NAME="final-models/seq2seq/sri/py150/normal/"
MODEL_NAME="final-models/seq2seq/sri/py150/finetuned_sri_transformer_random_decoder-only-false-epochs-10"
NUM_REPLACE=1500
...
./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 1 false false false v2-3-z_rand_1-pgd_1_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-0.10 $TRANSFORM_NAME 0.25 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 5 false false false v2-3-z_rand_1-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-0.75 $TRANSFORM_NAME 0.25 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 7 false false false v2-3-z_rand_1-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-0.25 $TRANSFORM_NAME 0.25 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 9 false false false v2-3-z_rand_1-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-0.5 $TRANSFORM_NAME 0.25 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 3 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-025 $TRANSFORM_NAME 0.25 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 3 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-025 $TRANSFORM_NAME 0.25 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 3 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-025 $TRANSFORM_NAME 0.25 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
# ./experiments/attack_and_test_transformer.sh 0 2 1 false 1 1 true 3 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-lr-4 $TRANSFORM_NAME 4.0 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
