...
MODEL_NAME="final-models/seq2seq/codeclone/java/finetuned-codeclone-adv/"
...
./experiments/attack_and_test_seq2seq_codeclone.sh 1 2 1 false 1 1 true 1 false false false v2-3-z_rand_1-pgd_3_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true false false "Best_F1"
# # no attack
