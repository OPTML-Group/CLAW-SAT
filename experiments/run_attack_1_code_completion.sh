...
# MODEL_NAME="final-models/seq2seq/code_completion/sri/py150/normal/"
...
# no attack, all sites
./experiments/attack_and_test_seq2seq_code_completion.sh 1 2 1 false 1 0 false 1 false true false v2-1-z_rand_all-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Best_F1"
