...
# MODEL_SHORT_NAME="CodeClaw-ST"
MODEL_SHORT_NAME="normal-AT"
...
# no attack, all sites
./experiments/attack_and_test_seq2seq_codeclone.sh 0 2 1 false 1 0 false 1 false true false v2-1-z_rand_all-pgd_rand_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME} $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Latest1"
lr=0.01
./experiments/attack_and_test_seq2seq_codeclone.sh 0 2 1 false 1 1 true 1 false false false v2-3-z_rand_3-pgd_1_no-$TRANSFORM_NAME-$DATASET_NAME_SMALL-${MODEL_SHORT_NAME}-${lr} $TRANSFORM_NAME ${lr} 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 0 true true false "Latest0"
# # no attack
