...
MODEL_NAME="final-models/seq2seq/$DATASET_NAME/finetuned_csn_h-sz-512-identity-adv-fz"
MODEL_NAME_SMALL="Advv1CLpf" 
EXPT_NAME="v2-3-z_rand_1-pgd_1_no-${TRANSFORM_NAME}-${DATASET_NAME_SMALL}-${MODEL_NAME_SMALL}-${EXACT_MATCHES}"
./experiments/adv_attack.sh 1 2 1 false 1 1 true 1 false false false $EXPT_NAME $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 1 true
MODEL_NAME="final-models/seq2seq/$DATASET_NAME/finetuned_csn_h-sz-512-identity-adv"
MODEL_NAME_SMALL="Advv1CLff" 
EXPT_NAME="v2-3-z_rand_1-pgd_1_no-${TRANSFORM_NAME}-${DATASET_NAME_SMALL}-${MODEL_NAME_SMALL}-${EXACT_MATCHES}"
./experiments/adv_attack.sh 1 2 1 false 1 1 true 1 false false false $EXPT_NAME $TRANSFORM_NAME 0.5 0.5 0.01 $DATASET_NAME 1 $MODEL_NAME $NUM_REPLACE 1 true
