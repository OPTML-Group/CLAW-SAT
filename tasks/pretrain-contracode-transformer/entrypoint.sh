...
#     --num_epochs=100 --batch_size=96 --lr=1e-5 --num_workers=4 \
...
#     --encoder_type transformer --lstm_project_mode hidden_identity --n_encoder_layers 6 \
...
#     --num_epochs=100 --batch_size=256 --lr=1e-4 --num_workers=4 \
#     --subword_regularization_alpha 0.1 --program_mode adv_contrastive --save_every 5000 \
#     --train_filepath=/inputs/augmented/train.pkl.gz \
#     --min_alternatives 2 --dist_url tcp://localhost:10001 --rank 0 \
#     --encoder_type adv --lstm_project_mode hidden_identity --n_encoder_layers 2 \
#     --loss_mode adv \
#     --d_model 512 --d_rep 512 \
#     --num_replacements 1500 \
#     --vocab_filepath /outputs/seq2seq/$DATASET/finetuned_csn_h-sz-512-identity-random-fz/lstm/checkpoints/Best_F1/input_vocab.pt \
#     --max_length 130