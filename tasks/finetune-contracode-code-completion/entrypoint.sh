...
python /model/train.py \
    ...
    --dev_path ${VALID_FILE} \
    --expt_name lstm \
    --expt_dir /outputs/seq2seq/code_completion/${DATASET}/${MODEL_NAME} \
    --load_checkpoint /outputs/contracode/${CHECKPOINT} \
    --batch_size 64 \
    --epochs $EPOCHS \
    --vocab_path /outputs/seq2seq/code_completion/${DATASET}/normal/lstm/checkpoints/Best_F1 \
    --finetune \
    --hidden_size 512 \
    ${FLAGS}
