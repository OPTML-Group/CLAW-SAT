...
.PHONY: build-image-compute-grad-with-input
build-image-compute-grad-with-input: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		compute-grad-with-input
...
.PHONY: build-image-extract-adv-dataset-tokens-code-completion
build-image-extract-adv-dataset-tokens-code-completion: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		extract-adv-dataset-tokens-code-completion

.PHONY: build-image-extract-adv-dataset-tokens-codeclone
build-image-extract-adv-dataset-tokens-codeclone: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		extract-adv-dataset-tokens-codeclone

.PHONY: build-image-extract-adv-dataset-tokens-transformer
build-image-extract-adv-dataset-tokens-transformer: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		extract-adv-dataset-tokens-transformer

.PHONY: build-image-plot-loss
build-image-plot-loss: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		plot-loss
		
.PHONY: build-image-adv-train-model-seq2seq-online
build-image-adv-train-model-seq2seq-online: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		adv-train-model-seq2seq-online

.PHONY: build-image-adv-train-model-seq2seq-online-codeclone
build-image-adv-train-model-seq2seq-online-codeclone: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		adv-train-model-seq2seq-online-codeclone

.PHONY: build-image-adv-train-model-seq2seq-online-codecompletion
build-image-adv-train-model-seq2seq-online-codecompletion: submodules ## Builds our adversarial dataset extractor (representation: tokens). <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		adv-train-model-seq2seq-online-codecompletion
...
.PHONY: build-image-normalize-raw-dataset-codeclone
build-image-normalize-raw-dataset-codeclone: submodules ## Builds our dataset normalizer docker image  <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-image.sh" \
		normalize-raw-dataset-codeclone
...
.PHONY: build-image-preprocess-dataset-tokens-codeclone
build-image-preprocess-dataset-tokens-codeclone: submodules ## Builds our tokens dataset preprocessor (for seq2seq model)  <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-image.sh" \
		preprocess-dataset-tokens-codeclone

.PHONY: build-image-preprocess-dataset-tokens-codeclone-aug
build-image-preprocess-dataset-tokens-codeclone-aug: submodules ## Builds our tokens dataset preprocessor (for seq2seq model)  <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-image.sh" \
		preprocess-dataset-tokens-codeclone-aug

.PHONY: build-image-preprocess-dataset-tokens-code-completion
build-image-preprocess-dataset-tokens-code-completion: submodules ## Builds our tokens dataset preprocessor (for seq2seq model)  <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-image.sh" \
		preprocess-dataset-tokens-code-completion
...
.PHONY: build-image-spoon-apply-transforms-codeclone
build-image-spoon-apply-transforms-codeclone: submodules ## Builds our dockerized version of spoon. <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-image.sh" \
		spoon-apply-transforms-codeclone
...
.PHONY: build-image-test-model-seq2seq-codeclone
build-image-test-model-seq2seq-codeclone: submodules ## Build tasks/test-model-seq2seq <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		test-model-seq2seq-codeclone

.PHONY: build-image-test-model-seq2seq-code-completion
build-image-test-model-seq2seq-code-completion: submodules ## Build tasks/test-model-seq2seq <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		test-model-seq2seq-code-completion

.PHONY: build-image-test-model-transformer
build-image-test-model-transformer: submodules ## Build tasks/test-model-transformer <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
...
.PHONY: build-image-train-model-codeclone
build-image-train-model-codeclone: submodules ## Build tasks/train-model-seq2seq <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		train-model-codeclone

.PHONY: build-image-test-model-voc
build-image-test-model-voc: submodules ## Build tasks/train-model-seq2seq <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		test-model-voc

.PHONY: build-image-train-model-seq2seq-code-completion
build-image-train-model-seq2seq-code-completion: submodules ## Build tasks/train-model-seq2seq <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		train-model-seq2seq-code-completion

.PHONY: build-image-train-model-transformer
build-image-train-model-transformer: submodules ## Build tasks/train-model-transformer <!PRIVATE>
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		train-model-transformer
		
.PHONY: build-image-augment-dataset
build-image-augment-dataset: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		augment-dataset

.PHONY: build-image-augment-dataset-codeclone
build-image-augment-dataset-codeclone: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		augment-dataset-codeclone
		
.PHONY: build-image-train-spm
build-image-train-spm: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		train-spm

.PHONY: build-image-pretrain-contracode
build-image-pretrain-contracode: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		pretrain-contracode

.PHONY: build-image-pretrain-contracode-codeclone
build-image-pretrain-contracode-codeclone: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		pretrain-contracode-codeclone

.PHONY: build-image-pretrain-contracode-transformer
build-image-pretrain-contracode-transformer: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		pretrain-contracode-transformer

.PHONY: build-image-adv-pretrain-contracode
build-image-adv-pretrain-contracode: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		adv-pretrain-contracode

.PHONY: build-image-adv-pretrain-contracode-codeclone
build-image-adv-pretrain-contracode-codeclone: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		adv-pretrain-contracode-codeclone

.PHONY: build-image-adv-pretrain-contracode-transformer
build-image-adv-pretrain-contracode-transformer: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		adv-pretrain-contracode-transformer

.PHONY: build-image-finetune-contracode
build-image-finetune-contracode: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		finetune-contracode

.PHONY: build-image-finetune-contracode-code-completion
build-image-finetune-contracode-code-completion: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		finetune-contracode-code-completion

.PHONY: build-image-finetune-contracode-codeclone
build-image-finetune-contracode-codeclone: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		finetune-contracode-codeclone

.PHONY: build-image-finetune-contracode-transformer
build-image-finetune-contracode-transformer: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		finetune-contracode-transformer

.PHONY: build-image-finetune-contracode-co
build-image-finetune-contracode-co: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		finetune-contracode-co

.PHONY: build-image-compute-w
build-image-compute-w: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
		compute-w

.PHONY: build-image-test-finetuned-model
build-image-test-finetuned-model: submodules 
	@"${ROOT_DIR}/scripts/build-model-image.sh" \
...
datasets/normalized/codeclone/java: ## Generates a normalized version of CodeSearchNet's Java dataset <!PRIVATE>
	@$(call echo_debug,"Normalizing dataset 'raw/bigclone/java'...")
	@$(call mkdir_cleanup_on_error,$@)
	@IMAGE_NAME="$(shell whoami)/averloc--normalize-raw-dataset-codeclone:$(shell git rev-parse HEAD)"
	docker run -it --rm \
		-v "${ROOT_DIR}/datasets/raw/codeclone/:/mnt/inputs" \
		-v "${ROOT_DIR}/datasets/normalized/codeclone/java:/mnt/outputs" \
		"$${IMAGE_NAME}" java gz 1665 1665 1665
	@$(call echo_debug,"  + Normalization complete!")
...
datasets/normalized/csn/python: ## Generates a normalized version of CodeSearchNet's Python dataset <!PRIVATE>
	...
	docker run -it --rm \
		...
		"$${IMAGE_NAME}" python gz 400000 10000 20000
	@$(call echo_debug,"  + Normalization complete!")
...
# ND_DEPS += datasets/normalized/bigclone/java
...
.PHONY: normalize-datasets-codeclone
normalize-datasets-codeclone: build-image-normalize-raw-dataset-codeclone | datasets/normalized/codeclone/java ## (DS-2) Normalizes all downloaded datasets
	@$(call echo_info,"Normalized all datasets to './datasets/normalized/' directory.")
#######################################################################################################################
#######################################################################################################################
...
datasets/transformed/preprocessed/tokens/codeclone/java: ## Generate a preprocessed (representation: tokens) version of code2seq's java-med dataset  <!PRIVATE>
	@$(call echo_debug,"Finalizing dataset 'transformed/preprocessed/tokens/c2s/java-med' (using 'tokens' representation)...")
	@$(call mkdir_cleanup_on_error,$@)
	@IMAGE_NAME="$(shell whoami)/averloc--preprocess-dataset-tokens-codeclone:$(shell git rev-parse HEAD)"
	@for transform in ${ALL_TRANSFORMS}; do 
		docker run -it --rm \
			-v "${ROOT_DIR}/datasets/transformed/normalized/codeclone/java/$${transform}:/mnt/inputs" \
			-v "${ROOT_DIR}/datasets/normalized/codeclone/java/:/mnt/index" \
			-v "${ROOT_DIR}/datasets/raw/codeclone/:/mnt/train_file" \
			-v "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/codeclone/java/$${transform}:/mnt/outputs" \
			"$${IMAGE_NAME}"
	done
	@$(call echo_debug,"  + Finalizing (using 'tokens' representation) complete!")

datasets/transformed/aug/tokens/codeclone/java: ## Generate a preprocessed (representation: tokens) version of code2seq's java-med dataset  <!PRIVATE>
	@$(call echo_debug,"Finalizing dataset 'transformed/preprocessed/tokens/c2s/java-med' (using 'tokens' representation)...")
	@$(call mkdir_cleanup_on_error,$@)
	@IMAGE_NAME="$(shell whoami)/averloc--preprocess-dataset-tokens-codeclone-aug:$(shell git rev-parse HEAD)"
	@for transform in ${ALL_TRANSFORMS}; do 
		docker run -it --rm \
			-v "${ROOT_DIR}/datasets/transformed/normalized/codeclone/java/$${transform}:/mnt/inputs" \
			-v "${ROOT_DIR}/datasets/normalized/codeclone/java/:/mnt/index" \
			-v "${ROOT_DIR}/datasets/raw/codeclone/:/mnt/train_file" \
			-v "${ROOT_DIR}/datasets/transformed/aug/tokens/codeclone/java/$${transform}:/mnt/outputs" \
			"$${IMAGE_NAME}"
	done
	@$(call echo_debug,"  + Finalizing (using 'tokens' representation) complete!")
...
.PHONY: extract-transformed-tokens-codeclone
extract-transformed-tokens-codeclone: build-image-preprocess-dataset-tokens-codeclone | datasets/transformed/preprocessed/tokens/codeclone/java ## (DS-6) Extract preprocessed representations (tokens) from our transfromed (normalized) datasets 
	@$(call echo_info,"Tokens preprocessed representations extracted (for transformed datasets)!")

.PHONY: extract-transformed-tokens-codeclone-aug
extract-transformed-tokens-codeclone-aug: build-image-preprocess-dataset-tokens-codeclone-aug | datasets/transformed/preprocessed/tokens/codeclone/java ## (DS-6) Extract preprocessed representations (tokens) from our transfromed (normalized) datasets 
	@$(call echo_info,"Tokens preprocessed representations extracted (for transformed datasets)!")

datasets/code_completion/transformed/preprocessed/tokens/sri/py150: ## Generate a preprocessed (representation: tokens) version of SRI Lab's py150k dataset  <!PRIVATE>
	@$(call echo_debug,"Finalizing dataset 'transformed/preprocessed/tokens/sri/py150' (using 'tokens' representation)...")
	@$(call mkdir_cleanup_on_error,$@)
	@IMAGE_NAME="$(shell whoami)/averloc--preprocess-dataset-tokens-code-completion:$(shell git rev-parse HEAD)"
	@for transform in ${ALL_TRANSFORMS}; do 
		docker run -it --rm \
			-v "${ROOT_DIR}/datasets/code_completion/transformed/normalized/sri/py150/$${transform}:/mnt/inputs" \
			-v "${ROOT_DIR}/datasets/code_completion/transformed/preprocessed/tokens/sri/py150/$${transform}:/mnt/outputs" \
			"$${IMAGE_NAME}"
	done
	@$(call echo_debug,"  + Finalizing (using 'tokens' representation) complete!")
ETTC_DEPS := datasets/code_completion/transformed/preprocessed/tokens/sri/py150

.PHONY: extract-transformed-tokens-code-completion
extract-transformed-tokens-code-completion: build-image-preprocess-dataset-tokens-code-completion | $(ETTC_DEPS) ## (DS-6) Extract preprocessed representations (tokens) from our transfromed (normalized) datasets 
	@$(call echo_info,"Tokens preprocessed representations extracted (for transformed datasets)!")
...
.PHONY: test-model-seq2seq-code-completion
test-model-seq2seq-code-completion: check-dataset-name check-results-out check-gpu check-models-in build-image-test-model-seq2seq-code-completion ## (TEST) Tests the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--test-model-seq2seq-code-completion:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
		-e SRC_FIELD="$${SRC_FIELD}" \
...
.PHONY: test-model-seq2seq-codeclone
test-model-seq2seq-codeclone: check-dataset-name check-results-out check-gpu check-models-in build-image-test-model-seq2seq-codeclone ## (TEST) Tests the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--test-model-seq2seq-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
		-e SRC_FIELD="$${SRC_FIELD}" \
...
.PHONY: test-model-transformer
test-model-transformer: check-dataset-name check-results-out check-gpu check-models-in build-image-test-model-transformer ## (TEST) Tests the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--test-model-transformer:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
		-e SRC_FIELD="$${SRC_FIELD}" \
...
train-model-seq2seq: check-dataset-name check-gpu check-models-out build-image-train-model-seq2seq  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	...
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
		-v "${ROOT_DIR}/$${MODELS_OUT}/normal:/mnt/outputs" \
		-v "${ROOT_DIR}/$${DATASET_NAME}:/mnt/inputs" \
		"$${IMAGE_NAME}" $${ARGS}

.PHONY: train-model-codeclone
train-model-codeclone: check-dataset-name check-gpu check-models-out build-image-train-model-codeclone  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--train-model-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
		-v "${ROOT_DIR}/$${MODELS_OUT}/normal:/mnt/outputs" \
...
.PHONY: test-model-voc
test-model-voc: check-dataset-name check-gpu check-models-out build-image-test-model-voc  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--test-model-voc:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
		-v "${ROOT_DIR}/$${MODELS_OUT}/union:/mnt/outputs" \
		-v "${ROOT_DIR}/$${DATASET_NAME}:/mnt/inputs" \
		-v "${ROOT_DIR}/$${DATASET_NAME_2}:/mnt/inputs_2" \
		"$${IMAGE_NAME}" $${ARGS}

.PHONY: train-model-seq2seq-code-completion
train-model-seq2seq-code-completion: check-dataset-name check-gpu check-models-out build-image-train-model-seq2seq-code-completion  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--train-model-seq2seq-code-completion:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
		-v "${ROOT_DIR}/$${MODELS_OUT}/normal:/mnt/outputs" \
...
.PHONY: train-model-transformer
train-model-transformer: check-dataset-name check-gpu check-models-out build-image-train-model-transformer  ## (TRAIN) Trains the transformer model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--train-model-transformer:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
		-v "${ROOT_DIR}/$${MODELS_OUT}/normal:/mnt/outputs" \
...
adv-train-model-seq2seq: check-dataset-name check-gpu check-models-out build-image-train-model-seq2seq  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	...
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		...
		-v "${ROOT_DIR}/$${MODELS_OUT}/adversarial:/mnt/outputs" \
		-v "${ROOT_DIR}/$${DATASET_NAME}:/mnt/inputs" \
		-v "${ROOT_DIR}/$${TRAIN_INFO_DIR}:/mnt/train_info" \
		"$${IMAGE_NAME}" $${ARGS}

.PHONY: adv-train-model-seq2seq-codeclone
adv-train-model-seq2seq-codeclone: check-dataset-name check-gpu check-models-out build-image-train-model-codeclone  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--train-model-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
...
.PHONY: adv-train-model-seq2seq-code-completion
adv-train-model-seq2seq-code-completion: check-dataset-name check-gpu check-models-out build-image-train-model-seq2seq-code-completion  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--train-model-seq2seq-code-completion:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
...
.PHONY: adv-train-model-transformer
adv-train-model-transformer: check-dataset-name check-gpu check-models-out build-image-train-model-transformer  ## (TRAIN) Trains the seq2seq model on a selected dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--train-model-transformer:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DECODER_ONLY="$${DECODER_ONLY}" \
...
.PHONY: compute-grad-with-input
compute-grad-with-input: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-compute-grad-with-input
	@IMAGE_NAME="$(shell whoami)/averloc--compute-grad-with-input:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
...
.PHONY: extract-adv-dataset-tokens-code-completion
extract-adv-dataset-tokens-code-completion: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-extract-adv-dataset-tokens-code-completion
	@IMAGE_NAME="$(shell whoami)/averloc--extract-adv-dataset-tokens-code-completion:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
		...
		-e CURRENT_ATTACK_EPOCH=$${CURRENT_ATTACK_EPOCH} \
 		-v "${ROOT_DIR}/final-results:/final-results" \
		-v "${ROOT_DIR}/$${MODELS_IN}:/models" \
		-v "${ROOT_DIR}/datasets/code_completion/transformed/preprocessed/tokens/$${DATASET}:/mnt/inputs" \
		-v "${ROOT_DIR}/datasets/code_completion/adversarial/$${SHORT_NAME}/tokens/$${DATASET}:/mnt/outputs" \
		"$${IMAGE_NAME}" $$(find "${ROOT_DIR}/datasets/code_completion/transformed/preprocessed/tokens/$${DATASET}" -type d | grep -Po "$${TRANSFORMS}")

.PHONY: extract-adv-dataset-tokens-codeclone
extract-adv-dataset-tokens-codeclone: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-extract-adv-dataset-tokens-codeclone
	@IMAGE_NAME="$(shell whoami)/averloc--extract-adv-dataset-tokens-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
		...
		-v "${ROOT_DIR}/$${MODELS_IN}:/models" \
		-v "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/$${DATASET}:/mnt/inputs" \
		-v "${ROOT_DIR}/datasets/codeclone/adversarial/$${SHORT_NAME}/tokens/$${DATASET}:/mnt/outputs" \
		"$${IMAGE_NAME}" $$(find "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/$${DATASET}" -type d | grep -Po "$${TRANSFORMS}")

.PHONY: extract-adv-dataset-tokens-transformer
extract-adv-dataset-tokens-transformer: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-extract-adv-dataset-tokens-transformer
	@IMAGE_NAME="$(shell whoami)/averloc--extract-adv-dataset-tokens-transformer:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
...
.PHONY: plot-loss
plot-loss: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-plot-loss
	@IMAGE_NAME="$(shell whoami)/averloc--plot-loss:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
...
.PHONY: adv-train-model-seq2seq-online
adv-train-model-seq2seq-online: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-adv-train-model-seq2seq-online
	@IMAGE_NAME="$(shell whoami)/averloc--adv-train-model-seq2seq-online:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
...
.PHONY: adv-train-model-seq2seq-online-codeclone
adv-train-model-seq2seq-online-codeclone: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-adv-train-model-seq2seq-online-codeclone
	@IMAGE_NAME="$(shell whoami)/averloc--adv-train-model-seq2seq-online-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
...
.PHONY: adv-train-model-seq2seq-online-codecompletion
adv-train-model-seq2seq-online-codecompletion: | check-dataset check-checkpoint check-short-name check-transforms check-gpu check-models-in build-image-adv-train-model-seq2seq-online-codecompletion
	@IMAGE_NAME="$(shell whoami)/averloc--adv-train-model-seq2seq-online-codecompletion:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e N_ALT_ITERS=$${N_ALT_ITERS} \
		-e Z_OPTIM=$${Z_OPTIM} \
...
.PHONY: apply-transforms-codeclone-java
apply-transforms-codeclone-java: build-image-spoon-apply-transforms-codeclone ## (DS-4) Apply our suite of transforms to code2seq's java-small dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--spoon-apply-transforms-codeclone:$(shell git rev-parse HEAD)"
	docker run -it --rm \
		-e DEPTH="$${DEPTH}" \
		-e NUM_SAMPLES="$${NUM_SAMPLES}" \
		-e AVERLOC_JUST_TEST="$${AVERLOC_JUST_TEST}" \
		-v "${ROOT_DIR}/datasets/normalized/codeclone/java:/mnt/inputs" \
		-v "${ROOT_DIR}/datasets/transformed/normalized/codeclone/java:/mnt/outputs" \
	  -v "${ROOT_DIR}/vendor/CodeSearchNet/function_parser/function_parser:/src/function-parser/function_parser" \
		-v "${ROOT_DIR}/tasks/spoon-apply-transforms-codeclone/jars/spoon.jar:/app/spoon.jar" \
		-v "${ROOT_DIR}/tasks/spoon-apply-transforms-codeclone/Transforms.java:/app/Transforms.java" \
		-v "${ROOT_DIR}/tasks/spoon-apply-transforms-codeclone/transforms:/app/transforms" \
		"$${IMAGE_NAME}"
...
.PHONY: apply-transforms-sri-py150-code-completion
apply-transforms-sri-py150-code-completion: build-image-astor-apply-transforms ## (DS-4) Apply our suite of transforms to SRI Lab's py150k dataset.
	@IMAGE_NAME="$(shell whoami)/averloc--astor-apply-transforms:$(shell git rev-parse HEAD)"
	@$(call echo_debug,"Testing astor on normalized sri/py150 files...")
	docker run -it --rm \
		-e DEPTH="$${DEPTH}" \
		...
		-v "${ROOT_DIR}/datasets/normalized/sri/py150:/mnt/inputs" \
		-v "${ROOT_DIR}/tasks/astor-apply-transforms:/app" \
		-v "${ROOT_DIR}/datasets/code_completion/transformed/normalized/sri/py150:/mnt/outputs" \
		"$${IMAGE_NAME}"
#######################################################################################################################
#######################################################################################################################
...
.PHONY: augment-dataset
augment-dataset: | build-image-augment-dataset
	@IMAGE_NAME="$(shell whoami)/averloc--augment-dataset:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		-e SPLIT="$${SPLIT}" \
		-e EXPT_NAME="$${EXPT_NAME}" \
		-e TRANSFORM="$${TRANSFORM}" \
		-v "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/$${DATASET}/$${TRANSFORM}:/mnt/preprocessed" \
		-v "${ROOT_DIR}/datasets/adversarial/$${EXPT_NAME}/tokens/$${DATASET}:/mnt/adversarial" \
		-v "${ROOT_DIR}/datasets/augmented/$${EXPT_NAME}/tokens/$${DATASET}:/mnt/augmented" \
		-v "${ROOT_DIR}/datasets/augmented:/mnt/augmented_dir" \
		-v "${ROOT_DIR}/final-models/seq2seq/$${DATASET}/normal/lstm/checkpoints/Best_F1:/mnt/model" \
		-v "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/$${DATASET}:/mnt/inputs" \
		-v "${ROOT_DIR}/datasets/adversarial/$${EXPT_NAME}/tokens/$${DATASET}:/mnt/outputs" \
		"$${IMAGE_NAME}" $$(find "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/$${DATASET}" -type d | grep -Po "$${TRANSFORM}")

.PHONY: augment-dataset-codeclone
augment-dataset-codeclone: | build-image-augment-dataset-codeclone
	@IMAGE_NAME="$(shell whoami)/averloc--augment-dataset-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		-e SPLIT="$${SPLIT}" \
		-e EXPT_NAME="$${EXPT_NAME}" \
		-e TRANSFORM="$${TRANSFORM}" \
		-v "${ROOT_DIR}/datasets/transformed/aug/tokens/$${DATASET}/$${TRANSFORM}:/mnt/preprocessed" \
		-v "${ROOT_DIR}/datasets/adversarial/$${EXPT_NAME}/tokens/$${DATASET}:/mnt/adversarial" \
		-v "${ROOT_DIR}/datasets/augmented/$${EXPT_NAME}/tokens/$${DATASET}:/mnt/augmented" \
		-v "${ROOT_DIR}/datasets/augmented/:/mnt/augmented_dir" \
		-v "${ROOT_DIR}/final-models/seq2seq/codeclone/java/union/lstm/:/mnt/model" \
		-v "${ROOT_DIR}/datasets/transformed/aug/tokens/$${DATASET}:/mnt/inputs" \
		-v "${ROOT_DIR}/datasets/adversarial/$${EXPT_NAME}/tokens/$${DATASET}:/mnt/outputs" \
		"$${IMAGE_NAME}" $$(find "${ROOT_DIR}/datasets/transformed/codeclone/tokens/$${DATASET}" -type d | grep -Po "$${TRANSFORM}")

.PHONY: train-spm
train-spm: | build-image-train-spm
	@IMAGE_NAME="$(shell whoami)/averloc--train-spm:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		-v "${ROOT_DIR}/datasets/transformed/normalized/sri/py150/transforms.Identity:/inputs" \
		-v "${ROOT_DIR}/final-models:/outputs" \
		"$${IMAGE_NAME}"

.PHONY: pretrain-contracode
pretrain-contracode: | build-image-pretrain-contracode
	@IMAGE_NAME="$(shell whoami)/averloc--pretrain-contracode:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus all \
		-e DATASET="$${DATASET}" \
		-e MODEL_NAME="$${MODEL_NAME}" \
		-v "${ROOT_DIR}/datasets/transformed/normalized/$${DATASET}/transforms.Identity:/inputs/raw" \
		-v "${ROOT_DIR}/datasets/augmented/$${VIEWS}/tokens/$${DATASET}:/inputs/augmented/" \
		-v "${ROOT_DIR}/final-models:/outputs" \
		-v "${ROOT_DIR}/models/contracode:/model" \
		"$${IMAGE_NAME}"

.PHONY: pretrain-contracode-codeclone
pretrain-contracode-codeclone: | build-image-pretrain-contracode-codeclone
	@IMAGE_NAME="$(shell whoami)/averloc--pretrain-contracode-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus all \
		-e DATASET="$${DATASET}" \
		-e MODEL_NAME="$${MODEL_NAME}" \
...
.PHONY: pretrain-contracode-transformer
pretrain-contracode-transformer: | build-image-pretrain-contracode-transformer
	@IMAGE_NAME="$(shell whoami)/averloc--pretrain-contracode-transformer:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus all \
		-e DATASET="$${DATASET}" \
		-e MODEL_NAME="$${MODEL_NAME}" \
...
.PHONY: adv-pretrain-contracode
adv-pretrain-contracode: | build-image-adv-pretrain-contracode
	@IMAGE_NAME="$(shell whoami)/averloc--adv-pretrain-contracode:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus all \
		-e DATASET="$${DATASET}" \
		-e MODEL_NAME="$${MODEL_NAME}" \
...
.PHONY: adv-pretrain-contracode-transformer
adv-pretrain-contracode-transformer: | build-image-adv-pretrain-contracode-transformer
	@IMAGE_NAME="$(shell whoami)/averloc--adv-pretrain-contracode-transformer:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus all \
		-e DATASET="$${DATASET}" \
		-e MODEL_NAME="$${MODEL_NAME}" \
...
.PHONY: adv-pretrain-contracode-codeclone
adv-pretrain-contracode-codeclone: | build-image-adv-pretrain-contracode-codeclone
	@IMAGE_NAME="$(shell whoami)/averloc--adv-pretrain-contracode-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus all \
		-e DATASET="$${DATASET}" \
		-e MODEL_NAME="$${MODEL_NAME}" \
...
.PHONY: finetune-contracode
finetune-contracode: | build-image-finetune-contracode
	@IMAGE_NAME="$(shell whoami)/averloc--finetune-contracode:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DATASET="$${DATASET}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
		...
		-e DECODER_ONLY="$${DECODER_ONLY}" \
		-e EPOCHS="$${EPOCHS}" \
		-v "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/$${DATASET}/transforms.Identity:/inputs/preprocessed" \
		-v "${ROOT_DIR}/final-models:/outputs" \
		-v "${ROOT_DIR}/models/contracode:/contracode" \
		-v "${ROOT_DIR}/final-models/seq2seq/$${DATASET}/normal/lstm/checkpoints/Best_F1/:/seq2seq_checkpoints" \
		"$${IMAGE_NAME}"

.PHONY: finetune-contracode-code-completion
finetune-contracode-code-completion: | build-image-finetune-contracode-code-completion
	@IMAGE_NAME="$(shell whoami)/averloc--finetune-contracode-code-completion:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DATASET="$${DATASET}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
		...
		-e DECODER_ONLY="$${DECODER_ONLY}" \
		-e EPOCHS="$${EPOCHS}" \
		-v "${ROOT_DIR}/datasets/code_completion/transformed/preprocessed/tokens/$${DATASET}/transforms.Identity:/inputs/preprocessed" \
		-v "${ROOT_DIR}/final-models:/outputs" \
		-v "${ROOT_DIR}/models/contracode:/contracode" \
		-v "${ROOT_DIR}/final-models/seq2seq/code_completion/$${DATASET}/normal/lstm/checkpoints/Best_F1/:/seq2seq_checkpoints" \
		"$${IMAGE_NAME}"

.PHONY: finetune-contracode-codeclone
finetune-contracode-codeclone: | build-image-finetune-contracode-codeclone
	@IMAGE_NAME="$(shell whoami)/averloc--finetune-contracode-codeclone:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DATASET="$${DATASET}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
		...
		-v "${ROOT_DIR}/final-models:/outputs" \
		-v "${ROOT_DIR}/models/contracode:/contracode" \
		-v "${ROOT_DIR}/final-models/seq2seq/codeclone/java/union/lstm/:/seq2seq_checkpoints" \
		"$${IMAGE_NAME}"

.PHONY: finetune-contracode-transformer
finetune-contracode-transformer: | build-image-finetune-contracode-transformer
	@IMAGE_NAME="$(shell whoami)/averloc--finetune-contracode-transformer:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DATASET="$${DATASET}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
...
.PHONY: finetune-contracode-co
finetune-contracode-co: | build-image-finetune-contracode-co
	@IMAGE_NAME="$(shell whoami)/averloc--finetune-contracode-co:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DATASET="$${DATASET}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
...
.PHONY: compute-w
compute-w: | build-image-compute-w
	@IMAGE_NAME="$(shell whoami)/averloc--compute-w:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e DATASET="$${DATASET}" \
		-e CHECKPOINT="$${CHECKPOINT}" \
...
.PHONY: test-finetuned-model
test-finetuned-model: | build-image-test-finetuned-model
	@IMAGE_NAME="$(shell whoami)/averloc--test-finetuned-model:$(shell git rev-parse HEAD)"
	DOCKER_API_VERSION=1.40 docker run -it --rm \
		--gpus "device=$${GPU}" \
		-e MODEL_TYPE="$${MODEL_TYPE}" \
		-v "${ROOT_DIR}/datasets/transformed/preprocessed/tokens/sri/py150/transforms.Identity:/inputs/preprocessed" \
		-v "${ROOT_DIR}/final-models:/outputs" \
		-v "${ROOT_DIR}/models/contracode:/contracode" \
		"$${IMAGE_NAME}"
