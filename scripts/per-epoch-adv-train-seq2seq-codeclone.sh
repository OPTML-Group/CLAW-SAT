...
echo "$FRE"
 ...
 docker run -it --rm \
   -v "${DIR}/../final-models/seq2seq/${DATASET}/${MODEL_NAME}":/mnt/inputs \
...
DATASET_NAME=datasets/codeclone/adversarial/${SHORT_NAME}/tokens/${DATASET}/${TARGETING}-targeting \
TRAIN_INFO_DIR=plots/${SHORT_NAME} \
  time make adv-train-model-seq2seq-codeclone
