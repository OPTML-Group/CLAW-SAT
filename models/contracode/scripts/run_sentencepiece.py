...
from representjs.data.jsonl_dataset import JSONLinesDataset, normalize_docstring, get_csnjs_dataset
...
def make_corpus(input=DEFAULT_INPUT, output=DEFAULT_OUTPUT):
    # dataset = JSONLinesDataset(input, {"source_code": "function"}, src_function_key="source_code")
    dataset = get_csnjs_dataset(input, 'sri/py150', 150000)
